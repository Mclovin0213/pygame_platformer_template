...
LEVEL_1 = {
    ...
    'main_layer': [
        ...
        "100D000000000000000000000000000000000S0000000OOOOO000000000000000000000000000K000000000000000001",
        "111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111111"
    ],
    ...
    'tile_mapping': {
        ...
        'M': TileType.PORTAL_SET_2,
        'O': TileType.PICKUP_COIN,    # 'O' for coin (circular shape)
        'A': TileType.PICKUP_ONEUP    # 'A' for apple (1-up)
    },
}
...
def parse_level_data(level_data):
    ...
    char_to_tile = level_data['tile_mapping']
